...
import LabTestsNavigator from '../Navigators/LabTestsNavigator';
...
export default function HomeNavigator() {
  return (
    <HomeStack.Navigator screenOptions={{ headerTitleAlign: 'center' }} >
      ...
      <HomeStack.Screen name="LabTestsNavigator" component={LabTestsNavigator} options={{ headerShown: false }} />
